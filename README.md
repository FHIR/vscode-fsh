...
Note that you must have `validator_cli.jar` installed locally in the `input-cache` directory.  You can get the latest release from [HAPI FHIR Github Repository](https://github.com/hapifhir/org.hl7.fhir.core/releases)
